...
import { getUserEarnings, getUserLinks, getUserPayoutData } from '@/app/actions/links'
...
export default async function DashboardPage() {
  ...
  const [stats, links, payoutData] = await Promise.all([getUserEarnings(), getUserLinks(), getUserPayoutData()])
